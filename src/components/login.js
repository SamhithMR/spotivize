...
const handleCopyClick = (textToCopy, id) => {
  ...
  id == 1 ? setCopiedText1(<TiTick/>) : id == 2 ? setCopiedText2(<TiTick />) : setCopiedText3(<TiTick />)
  setTimeout(() => {
    id == 1 ? setCopiedText1("") : id == 2 ? setCopiedText2("") : setCopiedText3("")
  }, 3000); 
};
...
return(
    <div className='login'>
        ...
        <div className="clientID">
          <div className="getClientID">
            <input type="text" placeholder='paste you clientID' onChange={(e)=>(setClientid(e.target.value))}/>
